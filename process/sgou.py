...
def deal(file_name):
    ...
    print "词库名：", byte2str(data[0x130:0x338])  #.encode('GB18030')  乱码是c语言里字符串结尾符‘\0’
...
if __name__ == '__main__':
    ...
    #将要转换的词库添加在这里就可以了
    fileNames = ['5.scel', '6.scel', '270.scel', '15097.scel', '15153.scel', '15182.scel', '15183.scel', '15201.scel',
                 '15486.scel',
                 '19431.scel', '22408.scel', '49111.scel']
    #fileNames=['旅游词汇大全【官方推荐】.scel']
    preContent = './../sgou/'
    fileList = [preContent + f for f in fileNames]
